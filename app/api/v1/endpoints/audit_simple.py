"""
Simple audit and compliance endpoints
"""
...
async def get_audit_report(
    ...
    try:
        ...
        model_drift_metrics = _calculate_model_drift()
        ...
        compliance_metrics = _calculate_compliance_metrics()
...
def _calculate_model_drift() -> Dict[str, Any]:
    """Calculate model drift metrics"""
    try:
...
def _calculate_fairness_metrics() -> Dict[str, Any]:
...
def _calculate_accuracy_metrics() -> Dict[str, Any]:
...
def _calculate_compliance_metrics() -> Dict[str, Any]:
...
async def export_audit_report(
    ...
    try:
        ...
        report_data = await get_audit_report(days=days)
        ...
        return {"error": f"Error exporting audit report: {str(e)}"}
